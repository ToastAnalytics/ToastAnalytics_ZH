...
注册APP的方法，请参考此链接（<http://docs.cloud.toast.com/ko/Analytics/App%20Analytics/Getting%20Started/#_4>）。
- 该文档以Unity4版本为基准所编写的。
...
为了使用SDK，需要有注册APP之后发放的“APP认证密钥”和“企业账号”。注册APP的方法，请参考此链接 (<http://docs.cloud.toast.com/ko/Analytics/App%20Analytics/Getting%20Started/#_4>)。
...
|launchPromotionPage| 启动推广页面。(Android)|
