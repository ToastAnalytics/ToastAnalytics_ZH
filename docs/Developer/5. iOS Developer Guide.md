...
![LibraryLink](https://github.com/ToastAnalytics/ToastAnalytics/raw/master/Documents/Developer/iOS%20Developer%20Guide/images/pg_ios_001.png)
...
### 2. 联动推送
在Analytics SDK中，为了举行活动需要启用APNS服务，而为了使用APNS，需要在Analytics的管理员页面注册证书。<br>
