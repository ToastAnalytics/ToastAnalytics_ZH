...
本篇主要介绍了在iOS操作系统中导入Analytics SDK的方法。为了使用Analytics SDK系统，必须先注册APP。APP的注册方法，请参考此链接（<http://docs.cloud.toast.com/ko/Analytics/App%20Analytics/Getting%20Started/#_4>）。 
